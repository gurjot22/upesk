			...
			$capri_footer_copyright = get_theme_mod(
				...
				sprintf(
					/* translators: $1%s: Theme link, %2$s WordPress link */
						apply_filters( 'capri_filter_copyright', esc_html__( '%1$s | Powered by %2$s', 'capri' ) ),
					/* translators: %s is Theme link */
						sprintf( '<a href="https://themeisle.com/themes/capri-pro" rel="nofollow" target="_blank">%s</a>', esc_html__( 'CAPRI', 'capri' ) ),
					/* translators: %s is WordPress name*/
						sprintf( '<a href="http://wordpress.org/" rel="nofollow" target="_blank">%s</a>', esc_html__( 'WordPress', 'capri' ) )
				)
			);
